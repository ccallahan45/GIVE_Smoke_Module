...
@defcomp Damages_RegionAggregatorSum_Smoke begin
    ...
    damage_smoke = Parameter(index=[time,ag_mapping_input_regions], unit="US\$2005/yr")
    ...
    damage_smoke_regions = Variable(index=[time,ag_mapping_output_regions], unit="US\$2005/yr")
    ...
    function run_timestep(p,v,d,t)
        ...
        for i in d.ag_mapping_input_regions
            ...
            v.damage_smoke_regions[t, v.input_output_mapping_int[i]] += p.damage_smoke[t,i]
        end
    end
end
